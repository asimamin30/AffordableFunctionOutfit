...
import com.nzdeveloper009.affordablefunctionoutfit.Seller.AddProducts.ProductDetails.GetWomenProductDetail;
import com.sdsmdg.tastytoast.TastyToast;

import java.util.ArrayList;

public class AddWomenProducts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_women_products);
        ...
        if (intent != null) {
            ...
            addProducts.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(getApplicationContext(), GetWomenProductDetail.class);
        ...
        reference.child(sellerUsername).child("Special Products")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        //setup adapter
                        adapterProductSeller = new AdapterProductSeller(AddWomenProducts.this,productList);
                        //set adapter
