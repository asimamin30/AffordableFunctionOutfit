...
public class MenProductOrderList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_men_product_order_list);
        ...
        filterOrderBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //dialog
                //dialog
                AlertDialog.Builder builder = new AlertDialog.Builder(MenProductOrderList.this);
    ...
    private void loadAllOrders() {
        ...
        reference.child("SELLER").child(sellerUsername).child("Orders").child("Men Products")
